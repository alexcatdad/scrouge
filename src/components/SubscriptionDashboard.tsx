...
export function SubscriptionDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "subscriptions" | "payments" | "chat" | "settings">("overview");
                ...
                <div className="divide-y divide-[rgba(113,113,122,0.1)]">
                  {subscriptions?.length === 0 ? (
                    ...
                    subscriptions?.slice(0, 5).map((sub) => (
                      <div key={sub._id} className="px-6 py-4 flex justify-between items-center hover:bg-white/[0.02] transition-colors">
                        <div>
