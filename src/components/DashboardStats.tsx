      ...
      {stats.map((stat, index) => (
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div
              className={`w-10 h-10 rounded-xl bg-gradient-to-br ${stat.iconBg} border ${stat.iconBorder} flex items-center justify-center`}
            >
          ...
          <div>
            ...
            {stat.subtitle && <p className="text-secondary/60 text-xs mt-1">{stat.subtitle}</p>}
          </div>
        </div>
      ))}
    </div>
