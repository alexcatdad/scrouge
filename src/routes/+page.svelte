		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div class="grid md:grid-cols-3 gap-8">
				<div class="p-6 bg-surface border border-zinc-800 rounded-xl">
					...
					<p class="text-secondary">Keep all your subscriptions in one place. Never forget about a renewal again.</p>
				</div>

				<div class="p-6 bg-surface border border-zinc-800 rounded-xl">
					<div class="w-12 h-12 bg-accent-teal/10 rounded-lg flex items-center justify-center mb-4">
						<svg class="w-6 h-6 text-accent-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
					</div>
					<h3 class="text-lg font-semibold text-white mb-2">See Your Spending</h3>
					<p class="text-secondary">Get insights into your monthly and yearly subscription costs at a glance.</p>
				</div>

				<div class="p-6 bg-surface border border-zinc-800 rounded-xl">
					<div class="w-12 h-12 bg-accent-coral/10 rounded-lg flex items-center justify-center mb-4">
						<svg class="w-6 h-6 text-accent-coral" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
						</svg>
					</div>
					<h3 class="text-lg font-semibold text-white mb-2">Get Reminders</h3>
					<p class="text-secondary">Receive notifications before renewals so you can cancel what you don't need.</p>
				</div>
			</div>
		</div>
	</section>
