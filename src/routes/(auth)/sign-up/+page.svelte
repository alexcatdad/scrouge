...
<div class="space-y-6">
	...
	<form onsubmit={handleSignUp} class="space-y-4">
		<div>
			<label for="name" class="block text-sm font-medium text-secondary mb-1">Name (optional)</label>
			<input
				id="name"
				type="text"
				bind:value={name}
	...
	<p class="text-center text-sm text-secondary">
		...
		<a href="/sign-in" class="text-primary hover:text-primary-hover transition-colors">
			Sign in
		</a>
	</p>
</div>
