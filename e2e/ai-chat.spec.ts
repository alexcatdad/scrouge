...
test.describe('AI Chat Interface', () => {
  test.describe('Guest Mode', () => {
    ...
    test('should allow guest users to use chat with WebLLM when WebGPU is supported', async ({ page }) => {
    ...
    test('should show WebGPU not supported message for guest users without WebGPU', async ({ page }) => {
